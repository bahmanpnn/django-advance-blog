...
#     # queryset=Post.objects.all()
#     context_object_name='posts'
#     # ordering='-id' ==>it does not work because we return objects from this class in get_queryset method
#     # not from its parent and super() so ordering and other methods will be have conflicts and problem
#
#     def get_queryset(self):
